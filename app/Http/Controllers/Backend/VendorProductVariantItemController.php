...
class VendorProductVariantItemController extends Controller
{
  ...
  public function update(Request $request, string $variantItemId)
  {
    ...
    return redirect()->route('vendor.product-variant-item.index', ['productId' => $variantItem->productVariant->product_id, 'variantId' => $variantItem->product_variant_id]);
  }

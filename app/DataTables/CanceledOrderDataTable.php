    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function($query) {
              ...
              $deleteBtn = "<a href='".route('admin.orders.destroy', $query->id)."' data-tableId='canceledorder-table' class='btn btn-danger ml-2 delete-item'><i class='far fa-trash-alt'></i></a>";

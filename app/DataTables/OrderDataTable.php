    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function($query) {
              ...
              $statusBtn = "<a href='".route('admin.product-additional-information.edit', $query->id)."' class='btn btn-info ml-2 mr-2'><i class='fas fa-truck'></i></a>";
              $deleteBtn = "<a href='".route('admin.product-additional-information.destroy', $query->id)."' data-tableId='order-table' class='btn btn-danger delete-item'><i class='far fa-trash-alt'></i></a>";

              return $showBtn.$statusBtn.$deleteBtn;
            })

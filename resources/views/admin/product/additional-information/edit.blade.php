                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <div class="card-header-action">
                      <a href="{{ route('admin.product-additional-information.index', ['product' => $productInfo->product_id]) }}" class="btn btn-secondary">Back</a>
                    </div>
                  </div>
                  <div class="card-body">
                    <form action="{{ route('admin.product-additional-information.update', $productInfo->id) }}" method="POST">
                      @csrf
                      @method('PUT')

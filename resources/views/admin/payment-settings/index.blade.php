                    ...
                    <div class="row">
                      <div class="col-2">
                        <div class="list-group" id="list-tab" role="tablist">
                          <a class="list-group-item list-group-item-action active" id="list-home-list" data-toggle="list" href="#list-paypal" role="tab">Paypal</a>
                      ...
                      <div class="col-10">
                        <div class="tab-content" id="nav-tabContent">
                          ...
                          @include('admin.payment-settings.payment_methods.paypal-settings')

                          @include('admin.payment-settings.payment_methods.stripe-settings')

                          @include('admin.payment-settings.payment_methods.cod-settings')

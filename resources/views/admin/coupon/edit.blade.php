                  ...
                  <div class="card-body">
                    <form action="{{ route('admin.coupons.update', $coupon->id) }}" method="POST">
                      ...
                      <div class="form-group" style="margin-bottom: 1rem">
                        ...
                        <input type="text"  name="max_use" class="form-control @error('max_use') is-invalid @enderror" value="{{ $coupon->max_use }}">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group" style="margin-bottom: 1rem">
                            ...
                            <input type="text"  name="start_date" class="form-control datepicker @error('start_date') is-invalid @enderror" value="{{ $coupon->start_date }}">
                        ...
                        <div class="col-md-6">
                          <div class="form-group" style="margin-bottom: 1rem">
                            ...
                            <input type="text"  name="end_date" class="form-control datepicker @error('end_date') is-invalid @enderror" value="{{ $coupon->end_date }}">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-8">
                          <div class="form-group" style="margin-bottom: 1rem">
                            ...
                            <input type="text"  name="discount_value" class="form-control @error('discount_value') is-invalid @enderror" value="{{ $coupon->discount_value }}">

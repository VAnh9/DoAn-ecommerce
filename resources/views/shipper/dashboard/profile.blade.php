              ...
              <div class="wsus__dash_pro_area">
                <h4>basic information</h4>
                    ...
                    <form action="{{ route('shipper.profile.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-xl-12">
                          <button class="common_btn mb-4 mt-3" type="submit">update</button>
                        </div>
                    </form>
                        ...
                        <div class="wsus__dash_pass_change mt-2">
                            <form action="{{ route('shipper.profile.update.password') }}" method="POST">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-xl-12">
                                      <button class="common_btn mt-3" type="submit">update</button>
                                    </div>
                                  </div>
                            </form>
                        </div>
